[etcher-sdk](../README.md) / [sourceDestination](../modules/sourceDestination.md) / SourceDestination

# Class: SourceDestination

[sourceDestination](../modules/sourceDestination.md).SourceDestination
...
- [constructor](sourceDestination.SourceDestination.md#constructor)

### Properties

- [isOpen](sourceDestination.SourceDestination.md#isopen)
- [metadata](sourceDestination.SourceDestination.md#metadata)
- [captureRejectionSymbol](sourceDestination.SourceDestination.md#capturerejectionsymbol)
- [captureRejections](sourceDestination.SourceDestination.md#capturerejections)
- [defaultMaxListeners](sourceDestination.SourceDestination.md#defaultmaxlisteners)
- [errorMonitor](sourceDestination.SourceDestination.md#errormonitor)
- [imageExtensions](sourceDestination.SourceDestination.md#imageextensions)
- [mimetype](sourceDestination.SourceDestination.md#mimetype)
- [mimetypes](sourceDestination.SourceDestination.md#mimetypes)

### Methods

- [[captureRejectionSymbol]](sourceDestination.SourceDestination.md#[capturerejectionsymbol])
- [\_close](sourceDestination.SourceDestination.md#_close)
- [\_getMetadata](sourceDestination.SourceDestination.md#_getmetadata)
- [\_open](sourceDestination.SourceDestination.md#_open)
- [addListener](sourceDestination.SourceDestination.md#addlistener)
- [canCreateReadStream](sourceDestination.SourceDestination.md#cancreatereadstream)
- [canCreateSparseReadStream](sourceDestination.SourceDestination.md#cancreatesparsereadstream)
- [canCreateSparseWriteStream](sourceDestination.SourceDestination.md#cancreatesparsewritestream)
- [canCreateWriteStream](sourceDestination.SourceDestination.md#cancreatewritestream)
- [canRead](sourceDestination.SourceDestination.md#canread)
- [canWrite](sourceDestination.SourceDestination.md#canwrite)
- [close](sourceDestination.SourceDestination.md#close)
- [createReadStream](sourceDestination.SourceDestination.md#createreadstream)
- [createSparseReadStream](sourceDestination.SourceDestination.md#createsparsereadstream)
- [createSparseWriteStream](sourceDestination.SourceDestination.md#createsparsewritestream)
- [createVerifier](sourceDestination.SourceDestination.md#createverifier)
- [createWriteStream](sourceDestination.SourceDestination.md#createwritestream)
- [emit](sourceDestination.SourceDestination.md#emit)
- [eventNames](sourceDestination.SourceDestination.md#eventnames)
- [getAlignment](sourceDestination.SourceDestination.md#getalignment)
- [getBlocks](sourceDestination.SourceDestination.md#getblocks)
- [getInnerSource](sourceDestination.SourceDestination.md#getinnersource)
- [getInnerSourceHelper](sourceDestination.SourceDestination.md#getinnersourcehelper)
- [getMaxListeners](sourceDestination.SourceDestination.md#getmaxlisteners)
- [getMetadata](sourceDestination.SourceDestination.md#getmetadata)
- [getMimeTypeFromContent](sourceDestination.SourceDestination.md#getmimetypefromcontent)
- [getMimeTypeFromName](sourceDestination.SourceDestination.md#getmimetypefromname)
- [getPartitionTable](sourceDestination.SourceDestination.md#getpartitiontable)
- [listenerCount](sourceDestination.SourceDestination.md#listenercount)
- [listeners](sourceDestination.SourceDestination.md#listeners)
- [off](sourceDestination.SourceDestination.md#off)
- [on](sourceDestination.SourceDestination.md#on)
- [once](sourceDestination.SourceDestination.md#once)
- [open](sourceDestination.SourceDestination.md#open)
- [prependListener](sourceDestination.SourceDestination.md#prependlistener)
- [prependOnceListener](sourceDestination.SourceDestination.md#prependoncelistener)
- [rawListeners](sourceDestination.SourceDestination.md#rawlisteners)
- [read](sourceDestination.SourceDestination.md#read)
- [removeAllListeners](sourceDestination.SourceDestination.md#removealllisteners)
- [removeListener](sourceDestination.SourceDestination.md#removelistener)
- [setMaxListeners](sourceDestination.SourceDestination.md#setmaxlisteners)
- [write](sourceDestination.SourceDestination.md#write)
- [addAbortListener](sourceDestination.SourceDestination.md#addabortlistener)
- [getEventListeners](sourceDestination.SourceDestination.md#geteventlisteners)
- [getMaxListeners](sourceDestination.SourceDestination.md#getmaxlisteners-1)
- [listenerCount](sourceDestination.SourceDestination.md#listenercount-1)
- [on](sourceDestination.SourceDestination.md#on-1)
- [once](sourceDestination.SourceDestination.md#once-1)
- [register](sourceDestination.SourceDestination.md#register)
- [setMaxListeners](sourceDestination.SourceDestination.md#setmaxlisteners-1)
...
[lib/source-destination/source-destination.ts:309](https://github.com/balena-io-modules/etcher-sdk/blob/00df1fd/lib/source-destination/source-destination.ts#L309)

___

### metadata

• `Private` **metadata**: [`Metadata`](../interfaces/sourceDestination.Metadata.md)

#### Defined in

[lib/source-destination/source-destination.ts:308](https://github.com/balena-io-modules/etcher-sdk/blob/00df1fd/lib/source-destination/source-destination.ts#L308)
...
▪ `Static` `Private` **mimetypes**: `Map`<`string`, typeof [`SourceSource`](sourceDestination.SourceSource.md)\>

#### Defined in

[lib/source-destination/source-destination.ts:306](https://github.com/balena-io-modules/etcher-sdk/blob/00df1fd/lib/source-destination/source-destination.ts#L306)
...
▸ **addListener**(`eventName`, `listener`): [`SourceDestination`](sourceDestination.SourceDestination.md)
...
[lib/source-destination/source-destination.ts:482](https://github.com/balena-io-modules/etcher-sdk/blob/00df1fd/lib/source-destination/source-destination.ts#L482)
...
set by `emitter.setMaxListeners(n)` or defaults to [defaultMaxListeners](sourceDestination.SourceDestination.md#defaultmaxlisteners).
...
[lib/source-destination/source-destination.ts:458](https://github.com/balena-io-modules/etcher-sdk/blob/00df1fd/lib/source-destination/source-destination.ts#L458)
...
[lib/source-destination/source-destination.ts:447](https://github.com/balena-io-modules/etcher-sdk/blob/00df1fd/lib/source-destination/source-destination.ts#L447)
...
▸ **off**(`eventName`, `listener`): [`SourceDestination`](sourceDestination.SourceDestination.md)
...
▸ **on**(`eventName`, `listener`): [`SourceDestination`](sourceDestination.SourceDestination.md)
...
▸ **once**(`eventName`, `listener`): [`SourceDestination`](sourceDestination.SourceDestination.md)
...
▸ **prependListener**(`eventName`, `listener`): [`SourceDestination`](sourceDestination.SourceDestination.md)
...
▸ **prependOnceListener**(`eventName`, `listener`): [`SourceDestination`](sourceDestination.SourceDestination.md)
...
▸ **removeAllListeners**(`event?`): [`SourceDestination`](sourceDestination.SourceDestination.md)
...
▸ **removeListener**(`eventName`, `listener`): [`SourceDestination`](sourceDestination.SourceDestination.md)
...
▸ **setMaxListeners**(`n`): [`SourceDestination`](sourceDestination.SourceDestination.md)
