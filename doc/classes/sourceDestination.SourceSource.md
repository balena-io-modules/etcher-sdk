[etcher-sdk](../README.md) / [sourceDestination](../modules/sourceDestination.md) / SourceSource

# Class: SourceSource

[sourceDestination](../modules/sourceDestination.md).SourceSource
...
- [constructor](sourceDestination.SourceSource.md#constructor)

### Properties

- [source](sourceDestination.SourceSource.md#source)
- [captureRejectionSymbol](sourceDestination.SourceSource.md#capturerejectionsymbol)
- [captureRejections](sourceDestination.SourceSource.md#capturerejections)
- [defaultMaxListeners](sourceDestination.SourceSource.md#defaultmaxlisteners)
- [errorMonitor](sourceDestination.SourceSource.md#errormonitor)
- [imageExtensions](sourceDestination.SourceSource.md#imageextensions)
- [mimetype](sourceDestination.SourceSource.md#mimetype)
- [requiresRandomReadableSource](sourceDestination.SourceSource.md#requiresrandomreadablesource)

### Methods

- [[captureRejectionSymbol]](sourceDestination.SourceSource.md#[capturerejectionsymbol])
- [\_close](sourceDestination.SourceSource.md#_close)
- [\_getMetadata](sourceDestination.SourceSource.md#_getmetadata)
- [\_open](sourceDestination.SourceSource.md#_open)
- [addListener](sourceDestination.SourceSource.md#addlistener)
- [canCreateReadStream](sourceDestination.SourceSource.md#cancreatereadstream)
- [canCreateSparseReadStream](sourceDestination.SourceSource.md#cancreatesparsereadstream)
- [canCreateSparseWriteStream](sourceDestination.SourceSource.md#cancreatesparsewritestream)
- [canCreateWriteStream](sourceDestination.SourceSource.md#cancreatewritestream)
- [canRead](sourceDestination.SourceSource.md#canread)
- [canWrite](sourceDestination.SourceSource.md#canwrite)
- [close](sourceDestination.SourceSource.md#close)
- [createReadStream](sourceDestination.SourceSource.md#createreadstream)
- [createSparseReadStream](sourceDestination.SourceSource.md#createsparsereadstream)
- [createSparseWriteStream](sourceDestination.SourceSource.md#createsparsewritestream)
- [createVerifier](sourceDestination.SourceSource.md#createverifier)
- [createWriteStream](sourceDestination.SourceSource.md#createwritestream)
- [emit](sourceDestination.SourceSource.md#emit)
- [eventNames](sourceDestination.SourceSource.md#eventnames)
- [getAlignment](sourceDestination.SourceSource.md#getalignment)
- [getBlocks](sourceDestination.SourceSource.md#getblocks)
- [getInnerSource](sourceDestination.SourceSource.md#getinnersource)
- [getMaxListeners](sourceDestination.SourceSource.md#getmaxlisteners)
- [getMetadata](sourceDestination.SourceSource.md#getmetadata)
- [getPartitionTable](sourceDestination.SourceSource.md#getpartitiontable)
- [listenerCount](sourceDestination.SourceSource.md#listenercount)
- [listeners](sourceDestination.SourceSource.md#listeners)
- [off](sourceDestination.SourceSource.md#off)
- [on](sourceDestination.SourceSource.md#on)
- [once](sourceDestination.SourceSource.md#once)
- [open](sourceDestination.SourceSource.md#open)
- [prependListener](sourceDestination.SourceSource.md#prependlistener)
- [prependOnceListener](sourceDestination.SourceSource.md#prependoncelistener)
- [rawListeners](sourceDestination.SourceSource.md#rawlisteners)
- [read](sourceDestination.SourceSource.md#read)
- [removeAllListeners](sourceDestination.SourceSource.md#removealllisteners)
- [removeListener](sourceDestination.SourceSource.md#removelistener)
- [setMaxListeners](sourceDestination.SourceSource.md#setmaxlisteners)
- [write](sourceDestination.SourceSource.md#write)
- [addAbortListener](sourceDestination.SourceSource.md#addabortlistener)
- [getEventListeners](sourceDestination.SourceSource.md#geteventlisteners)
- [getMaxListeners](sourceDestination.SourceSource.md#getmaxlisteners-1)
- [listenerCount](sourceDestination.SourceSource.md#listenercount-1)
- [on](sourceDestination.SourceSource.md#on-1)
- [once](sourceDestination.SourceSource.md#once-1)
- [register](sourceDestination.SourceSource.md#register)
- [setMaxListeners](sourceDestination.SourceSource.md#setmaxlisteners-1)
...
▸ **addListener**(`eventName`, `listener`): [`SourceSource`](sourceDestination.SourceSource.md)
...
set by `emitter.setMaxListeners(n)` or defaults to [defaultMaxListeners](sourceDestination.SourceSource.md#defaultmaxlisteners).
...
▸ **off**(`eventName`, `listener`): [`SourceSource`](sourceDestination.SourceSource.md)
...
▸ **on**(`eventName`, `listener`): [`SourceSource`](sourceDestination.SourceSource.md)
...
▸ **once**(`eventName`, `listener`): [`SourceSource`](sourceDestination.SourceSource.md)
...
▸ **prependListener**(`eventName`, `listener`): [`SourceSource`](sourceDestination.SourceSource.md)
...
▸ **prependOnceListener**(`eventName`, `listener`): [`SourceSource`](sourceDestination.SourceSource.md)
...
▸ **removeAllListeners**(`event?`): [`SourceSource`](sourceDestination.SourceSource.md)
...
▸ **removeListener**(`eventName`, `listener`): [`SourceSource`](sourceDestination.SourceSource.md)
...
▸ **setMaxListeners**(`n`): [`SourceSource`](sourceDestination.SourceSource.md)
