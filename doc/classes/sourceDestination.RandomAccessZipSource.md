[etcher-sdk](../README.md) / [sourceDestination](../modules/sourceDestination.md) / RandomAccessZipSource

# Class: RandomAccessZipSource

[sourceDestination](../modules/sourceDestination.md).RandomAccessZipSource
...
- [constructor](sourceDestination.RandomAccessZipSource.md#constructor)

### Properties

- [entries](sourceDestination.RandomAccessZipSource.md#entries)
- [match](sourceDestination.RandomAccessZipSource.md#match)
- [ready](sourceDestination.RandomAccessZipSource.md#ready)
- [source](sourceDestination.RandomAccessZipSource.md#source)
- [zip](sourceDestination.RandomAccessZipSource.md#zip)
- [captureRejectionSymbol](sourceDestination.RandomAccessZipSource.md#capturerejectionsymbol)
- [captureRejections](sourceDestination.RandomAccessZipSource.md#capturerejections)
- [defaultMaxListeners](sourceDestination.RandomAccessZipSource.md#defaultmaxlisteners)
- [errorMonitor](sourceDestination.RandomAccessZipSource.md#errormonitor)
- [imageExtensions](sourceDestination.RandomAccessZipSource.md#imageextensions)
- [manifestFields](sourceDestination.RandomAccessZipSource.md#manifestfields)
- [mimetype](sourceDestination.RandomAccessZipSource.md#mimetype)
- [requiresRandomReadableSource](sourceDestination.RandomAccessZipSource.md#requiresrandomreadablesource)

### Methods

- [[captureRejectionSymbol]](sourceDestination.RandomAccessZipSource.md#[capturerejectionsymbol])
- [\_close](sourceDestination.RandomAccessZipSource.md#_close)
- [\_getMetadata](sourceDestination.RandomAccessZipSource.md#_getmetadata)
- [\_open](sourceDestination.RandomAccessZipSource.md#_open)
- [addListener](sourceDestination.RandomAccessZipSource.md#addlistener)
- [canCreateReadStream](sourceDestination.RandomAccessZipSource.md#cancreatereadstream)
- [canCreateSparseReadStream](sourceDestination.RandomAccessZipSource.md#cancreatesparsereadstream)
- [canCreateSparseWriteStream](sourceDestination.RandomAccessZipSource.md#cancreatesparsewritestream)
- [canCreateWriteStream](sourceDestination.RandomAccessZipSource.md#cancreatewritestream)
- [canRead](sourceDestination.RandomAccessZipSource.md#canread)
- [canWrite](sourceDestination.RandomAccessZipSource.md#canwrite)
- [close](sourceDestination.RandomAccessZipSource.md#close)
- [createReadStream](sourceDestination.RandomAccessZipSource.md#createreadstream)
- [createSparseReadStream](sourceDestination.RandomAccessZipSource.md#createsparsereadstream)
- [createSparseWriteStream](sourceDestination.RandomAccessZipSource.md#createsparsewritestream)
- [createVerifier](sourceDestination.RandomAccessZipSource.md#createverifier)
- [createWriteStream](sourceDestination.RandomAccessZipSource.md#createwritestream)
- [emit](sourceDestination.RandomAccessZipSource.md#emit)
- [eventNames](sourceDestination.RandomAccessZipSource.md#eventnames)
- [getAlignment](sourceDestination.RandomAccessZipSource.md#getalignment)
- [getBlocks](sourceDestination.RandomAccessZipSource.md#getblocks)
- [getEntries](sourceDestination.RandomAccessZipSource.md#getentries)
- [getEntryByName](sourceDestination.RandomAccessZipSource.md#getentrybyname)
- [getImageEntry](sourceDestination.RandomAccessZipSource.md#getimageentry)
- [getInnerSource](sourceDestination.RandomAccessZipSource.md#getinnersource)
- [getJson](sourceDestination.RandomAccessZipSource.md#getjson)
- [getMaxListeners](sourceDestination.RandomAccessZipSource.md#getmaxlisteners)
- [getMetadata](sourceDestination.RandomAccessZipSource.md#getmetadata)
- [getPartitionTable](sourceDestination.RandomAccessZipSource.md#getpartitiontable)
- [getStream](sourceDestination.RandomAccessZipSource.md#getstream)
- [getString](sourceDestination.RandomAccessZipSource.md#getstring)
- [init](sourceDestination.RandomAccessZipSource.md#init)
- [listenerCount](sourceDestination.RandomAccessZipSource.md#listenercount)
- [listeners](sourceDestination.RandomAccessZipSource.md#listeners)
- [off](sourceDestination.RandomAccessZipSource.md#off)
- [on](sourceDestination.RandomAccessZipSource.md#on)
- [once](sourceDestination.RandomAccessZipSource.md#once)
- [open](sourceDestination.RandomAccessZipSource.md#open)
- [prependListener](sourceDestination.RandomAccessZipSource.md#prependlistener)
- [prependOnceListener](sourceDestination.RandomAccessZipSource.md#prependoncelistener)
- [rawListeners](sourceDestination.RandomAccessZipSource.md#rawlisteners)
- [read](sourceDestination.RandomAccessZipSource.md#read)
- [removeAllListeners](sourceDestination.RandomAccessZipSource.md#removealllisteners)
- [removeListener](sourceDestination.RandomAccessZipSource.md#removelistener)
- [setMaxListeners](sourceDestination.RandomAccessZipSource.md#setmaxlisteners)
- [write](sourceDestination.RandomAccessZipSource.md#write)
- [addAbortListener](sourceDestination.RandomAccessZipSource.md#addabortlistener)
- [getEventListeners](sourceDestination.RandomAccessZipSource.md#geteventlisteners)
- [getMaxListeners](sourceDestination.RandomAccessZipSource.md#getmaxlisteners-1)
- [listenerCount](sourceDestination.RandomAccessZipSource.md#listenercount-1)
- [on](sourceDestination.RandomAccessZipSource.md#on-1)
- [once](sourceDestination.RandomAccessZipSource.md#once-1)
- [register](sourceDestination.RandomAccessZipSource.md#register)
- [setMaxListeners](sourceDestination.RandomAccessZipSource.md#setmaxlisteners-1)
...
[lib/source-destination/zip.ts:164](https://github.com/balena-io-modules/etcher-sdk/blob/00df1fd/lib/source-destination/zip.ts#L164)
...
[lib/source-destination/zip.ts:162](https://github.com/balena-io-modules/etcher-sdk/blob/00df1fd/lib/source-destination/zip.ts#L162)
...
[lib/source-destination/zip.ts:166](https://github.com/balena-io-modules/etcher-sdk/blob/00df1fd/lib/source-destination/zip.ts#L166)
...
[lib/source-destination/zip.ts:161](https://github.com/balena-io-modules/etcher-sdk/blob/00df1fd/lib/source-destination/zip.ts#L161)
...
[lib/source-destination/zip.ts:160](https://github.com/balena-io-modules/etcher-sdk/blob/00df1fd/lib/source-destination/zip.ts#L160)
...
▪ `Static` `Private` **manifestFields**: keyof [`Metadata`](../interfaces/sourceDestination.Metadata.md)[]

#### Defined in

[lib/source-destination/zip.ts:150](https://github.com/balena-io-modules/etcher-sdk/blob/00df1fd/lib/source-destination/zip.ts#L150)
...
[lib/source-destination/zip.ts:319](https://github.com/balena-io-modules/etcher-sdk/blob/00df1fd/lib/source-destination/zip.ts#L319)
...
[lib/source-destination/zip.ts:226](https://github.com/balena-io-modules/etcher-sdk/blob/00df1fd/lib/source-destination/zip.ts#L226)

___

### addListener

▸ **addListener**(`eventName`, `listener`): [`RandomAccessZipSource`](sourceDestination.RandomAccessZipSource.md)
...
[lib/source-destination/zip.ts:196](https://github.com/balena-io-modules/etcher-sdk/blob/00df1fd/lib/source-destination/zip.ts#L196)
...
[lib/source-destination/zip.ts:200](https://github.com/balena-io-modules/etcher-sdk/blob/00df1fd/lib/source-destination/zip.ts#L200)
...
[lib/source-destination/zip.ts:270](https://github.com/balena-io-modules/etcher-sdk/blob/00df1fd/lib/source-destination/zip.ts#L270)

___

### createSparseReadStream

▸ **createSparseReadStream**(`«destructured»?`): `Promise`<[`SparseFilterStream`](sparseStream.SparseFilterStream.md)\>
...
[lib/source-destination/zip.ts:296](https://github.com/balena-io-modules/etcher-sdk/blob/00df1fd/lib/source-destination/zip.ts#L296)
...
[lib/source-destination/zip.ts:205](https://github.com/balena-io-modules/etcher-sdk/blob/00df1fd/lib/source-destination/zip.ts#L205)
...
[lib/source-destination/zip.ts:232](https://github.com/balena-io-modules/etcher-sdk/blob/00df1fd/lib/source-destination/zip.ts#L232)
...
[lib/source-destination/zip.ts:210](https://github.com/balena-io-modules/etcher-sdk/blob/00df1fd/lib/source-destination/zip.ts#L210)
...
[lib/source-destination/zip.ts:263](https://github.com/balena-io-modules/etcher-sdk/blob/00df1fd/lib/source-destination/zip.ts#L263)
...
set by `emitter.setMaxListeners(n)` or defaults to [defaultMaxListeners](sourceDestination.RandomAccessZipSource.md#defaultmaxlisteners).
...
`Promise`<`undefined` \| `ReadableStream`\>

#### Defined in

[lib/source-destination/zip.ts:241](https://github.com/balena-io-modules/etcher-sdk/blob/00df1fd/lib/source-destination/zip.ts#L241)
...
[lib/source-destination/zip.ts:255](https://github.com/balena-io-modules/etcher-sdk/blob/00df1fd/lib/source-destination/zip.ts#L255)
...
[lib/source-destination/zip.ts:172](https://github.com/balena-io-modules/etcher-sdk/blob/00df1fd/lib/source-destination/zip.ts#L172)
...
▸ **off**(`eventName`, `listener`): [`RandomAccessZipSource`](sourceDestination.RandomAccessZipSource.md)
...
▸ **on**(`eventName`, `listener`): [`RandomAccessZipSource`](sourceDestination.RandomAccessZipSource.md)
...
▸ **once**(`eventName`, `listener`): [`RandomAccessZipSource`](sourceDestination.RandomAccessZipSource.md)
...
▸ **prependListener**(`eventName`, `listener`): [`RandomAccessZipSource`](sourceDestination.RandomAccessZipSource.md)
...
▸ **prependOnceListener**(`eventName`, `listener`): [`RandomAccessZipSource`](sourceDestination.RandomAccessZipSource.md)
...
▸ **removeAllListeners**(`event?`): [`RandomAccessZipSource`](sourceDestination.RandomAccessZipSource.md)
...
▸ **removeListener**(`eventName`, `listener`): [`RandomAccessZipSource`](sourceDestination.RandomAccessZipSource.md)
...
▸ **setMaxListeners**(`n`): [`RandomAccessZipSource`](sourceDestination.RandomAccessZipSource.md)
