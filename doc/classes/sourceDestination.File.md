[etcher-sdk](../README.md) / [sourceDestination](../modules/sourceDestination.md) / File

# Class: File

[sourceDestination](../modules/sourceDestination.md).File
...
- [constructor](sourceDestination.File.md#constructor)

### Properties

- [fileHandle](sourceDestination.File.md#filehandle)
- [oWrite](sourceDestination.File.md#owrite)
- [path](sourceDestination.File.md#path)
- [captureRejectionSymbol](sourceDestination.File.md#capturerejectionsymbol)
- [captureRejections](sourceDestination.File.md#capturerejections)
- [defaultMaxListeners](sourceDestination.File.md#defaultmaxlisteners)
- [errorMonitor](sourceDestination.File.md#errormonitor)
- [imageExtensions](sourceDestination.File.md#imageextensions)
- [mimetype](sourceDestination.File.md#mimetype)

### Methods

- [[captureRejectionSymbol]](sourceDestination.File.md#[capturerejectionsymbol])
- [\_close](sourceDestination.File.md#_close)
- [\_getMetadata](sourceDestination.File.md#_getmetadata)
- [\_open](sourceDestination.File.md#_open)
- [addListener](sourceDestination.File.md#addlistener)
- [canCreateReadStream](sourceDestination.File.md#cancreatereadstream)
- [canCreateSparseReadStream](sourceDestination.File.md#cancreatesparsereadstream)
- [canCreateSparseWriteStream](sourceDestination.File.md#cancreatesparsewritestream)
- [canCreateWriteStream](sourceDestination.File.md#cancreatewritestream)
- [canRead](sourceDestination.File.md#canread)
- [canWrite](sourceDestination.File.md#canwrite)
- [close](sourceDestination.File.md#close)
- [createReadStream](sourceDestination.File.md#createreadstream)
- [createSparseReadStream](sourceDestination.File.md#createsparsereadstream)
- [createSparseWriteStream](sourceDestination.File.md#createsparsewritestream)
- [createVerifier](sourceDestination.File.md#createverifier)
- [createWriteStream](sourceDestination.File.md#createwritestream)
- [emit](sourceDestination.File.md#emit)
- [eventNames](sourceDestination.File.md#eventnames)
- [getAlignment](sourceDestination.File.md#getalignment)
- [getBlocks](sourceDestination.File.md#getblocks)
- [getInnerSource](sourceDestination.File.md#getinnersource)
- [getMaxListeners](sourceDestination.File.md#getmaxlisteners)
- [getMetadata](sourceDestination.File.md#getmetadata)
- [getOpenFlags](sourceDestination.File.md#getopenflags)
- [getPartitionTable](sourceDestination.File.md#getpartitiontable)
- [listenerCount](sourceDestination.File.md#listenercount)
- [listeners](sourceDestination.File.md#listeners)
- [off](sourceDestination.File.md#off)
- [on](sourceDestination.File.md#on)
- [once](sourceDestination.File.md#once)
- [open](sourceDestination.File.md#open)
- [prependListener](sourceDestination.File.md#prependlistener)
- [prependOnceListener](sourceDestination.File.md#prependoncelistener)
- [rawListeners](sourceDestination.File.md#rawlisteners)
- [read](sourceDestination.File.md#read)
- [removeAllListeners](sourceDestination.File.md#removealllisteners)
- [removeListener](sourceDestination.File.md#removelistener)
- [setMaxListeners](sourceDestination.File.md#setmaxlisteners)
- [write](sourceDestination.File.md#write)
- [addAbortListener](sourceDestination.File.md#addabortlistener)
- [getEventListeners](sourceDestination.File.md#geteventlisteners)
- [getMaxListeners](sourceDestination.File.md#getmaxlisteners-1)
- [listenerCount](sourceDestination.File.md#listenercount-1)
- [on](sourceDestination.File.md#on-1)
- [once](sourceDestination.File.md#once-1)
- [register](sourceDestination.File.md#register)
- [setMaxListeners](sourceDestination.File.md#setmaxlisteners-1)
...
[lib/source-destination/file.ts:50](https://github.com/balena-io-modules/etcher-sdk/blob/00df1fd/lib/source-destination/file.ts#L50)
...
[lib/source-destination/file.ts:48](https://github.com/balena-io-modules/etcher-sdk/blob/00df1fd/lib/source-destination/file.ts#L48)
...
[lib/source-destination/file.ts:47](https://github.com/balena-io-modules/etcher-sdk/blob/00df1fd/lib/source-destination/file.ts#L47)
...
[lib/source-destination/file.ts:46](https://github.com/balena-io-modules/etcher-sdk/blob/00df1fd/lib/source-destination/file.ts#L46)
...
[lib/source-destination/file.ts:215](https://github.com/balena-io-modules/etcher-sdk/blob/00df1fd/lib/source-destination/file.ts#L215)
...
[lib/source-destination/file.ts:83](https://github.com/balena-io-modules/etcher-sdk/blob/00df1fd/lib/source-destination/file.ts#L83)
...
[lib/source-destination/file.ts:205](https://github.com/balena-io-modules/etcher-sdk/blob/00df1fd/lib/source-destination/file.ts#L205)

___

### addListener

▸ **addListener**(`eventName`, `listener`): [`File`](sourceDestination.File.md)
...
[lib/source-destination/file.ts:71](https://github.com/balena-io-modules/etcher-sdk/blob/00df1fd/lib/source-destination/file.ts#L71)
...
[lib/source-destination/file.ts:79](https://github.com/balena-io-modules/etcher-sdk/blob/00df1fd/lib/source-destination/file.ts#L79)
...
[lib/source-destination/file.ts:75](https://github.com/balena-io-modules/etcher-sdk/blob/00df1fd/lib/source-destination/file.ts#L75)
...
[lib/source-destination/file.ts:63](https://github.com/balena-io-modules/etcher-sdk/blob/00df1fd/lib/source-destination/file.ts#L63)
...
[lib/source-destination/file.ts:67](https://github.com/balena-io-modules/etcher-sdk/blob/00df1fd/lib/source-destination/file.ts#L67)
...
[lib/source-destination/file.ts:147](https://github.com/balena-io-modules/etcher-sdk/blob/00df1fd/lib/source-destination/file.ts#L147)
...
[lib/source-destination/file.ts:194](https://github.com/balena-io-modules/etcher-sdk/blob/00df1fd/lib/source-destination/file.ts#L194)
...
▸ **createWriteStream**(`«destructured»?`): `Promise`<`WritableStream`\>
...
[lib/source-destination/file.ts:180](https://github.com/balena-io-modules/etcher-sdk/blob/00df1fd/lib/source-destination/file.ts#L180)
...
set by `emitter.setMaxListeners(n)` or defaults to [defaultMaxListeners](sourceDestination.File.md#defaultmaxlisteners).
...
[lib/source-destination/file.ts:56](https://github.com/balena-io-modules/etcher-sdk/blob/00df1fd/lib/source-destination/file.ts#L56)
...
▸ **off**(`eventName`, `listener`): [`File`](sourceDestination.File.md)
...
▸ **on**(`eventName`, `listener`): [`File`](sourceDestination.File.md)
...
▸ **once**(`eventName`, `listener`): [`File`](sourceDestination.File.md)
...
▸ **prependListener**(`eventName`, `listener`): [`File`](sourceDestination.File.md)
...
▸ **prependOnceListener**(`eventName`, `listener`): [`File`](sourceDestination.File.md)
...
[lib/source-destination/file.ts:90](https://github.com/balena-io-modules/etcher-sdk/blob/00df1fd/lib/source-destination/file.ts#L90)

___

### removeAllListeners

▸ **removeAllListeners**(`event?`): [`File`](sourceDestination.File.md)
...
▸ **removeListener**(`eventName`, `listener`): [`File`](sourceDestination.File.md)
...
▸ **setMaxListeners**(`n`): [`File`](sourceDestination.File.md)
...
[lib/source-destination/file.ts:138](https://github.com/balena-io-modules/etcher-sdk/blob/00df1fd/lib/source-destination/file.ts#L138)
