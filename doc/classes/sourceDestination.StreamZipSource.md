[etcher-sdk](../README.md) / [sourceDestination](../modules/sourceDestination.md) / StreamZipSource

# Class: StreamZipSource

[sourceDestination](../modules/sourceDestination.md).StreamZipSource
...
- [constructor](sourceDestination.StreamZipSource.md#constructor)

### Properties

- [entry](sourceDestination.StreamZipSource.md#entry)
- [match](sourceDestination.StreamZipSource.md#match)
- [source](sourceDestination.StreamZipSource.md#source)
- [captureRejectionSymbol](sourceDestination.StreamZipSource.md#capturerejectionsymbol)
- [captureRejections](sourceDestination.StreamZipSource.md#capturerejections)
- [defaultMaxListeners](sourceDestination.StreamZipSource.md#defaultmaxlisteners)
- [errorMonitor](sourceDestination.StreamZipSource.md#errormonitor)
- [imageExtensions](sourceDestination.StreamZipSource.md#imageextensions)
- [mimetype](sourceDestination.StreamZipSource.md#mimetype)
- [requiresRandomReadableSource](sourceDestination.StreamZipSource.md#requiresrandomreadablesource)

### Methods

- [[captureRejectionSymbol]](sourceDestination.StreamZipSource.md#[capturerejectionsymbol])
- [\_close](sourceDestination.StreamZipSource.md#_close)
- [\_getMetadata](sourceDestination.StreamZipSource.md#_getmetadata)
- [\_open](sourceDestination.StreamZipSource.md#_open)
- [addListener](sourceDestination.StreamZipSource.md#addlistener)
- [canCreateReadStream](sourceDestination.StreamZipSource.md#cancreatereadstream)
- [canCreateSparseReadStream](sourceDestination.StreamZipSource.md#cancreatesparsereadstream)
- [canCreateSparseWriteStream](sourceDestination.StreamZipSource.md#cancreatesparsewritestream)
- [canCreateWriteStream](sourceDestination.StreamZipSource.md#cancreatewritestream)
- [canRead](sourceDestination.StreamZipSource.md#canread)
- [canWrite](sourceDestination.StreamZipSource.md#canwrite)
- [close](sourceDestination.StreamZipSource.md#close)
- [createReadStream](sourceDestination.StreamZipSource.md#createreadstream)
- [createSparseReadStream](sourceDestination.StreamZipSource.md#createsparsereadstream)
- [createSparseWriteStream](sourceDestination.StreamZipSource.md#createsparsewritestream)
- [createVerifier](sourceDestination.StreamZipSource.md#createverifier)
- [createWriteStream](sourceDestination.StreamZipSource.md#createwritestream)
- [emit](sourceDestination.StreamZipSource.md#emit)
- [eventNames](sourceDestination.StreamZipSource.md#eventnames)
- [getAlignment](sourceDestination.StreamZipSource.md#getalignment)
- [getBlocks](sourceDestination.StreamZipSource.md#getblocks)
- [getEntry](sourceDestination.StreamZipSource.md#getentry)
- [getInnerSource](sourceDestination.StreamZipSource.md#getinnersource)
- [getMaxListeners](sourceDestination.StreamZipSource.md#getmaxlisteners)
- [getMetadata](sourceDestination.StreamZipSource.md#getmetadata)
- [getPartitionTable](sourceDestination.StreamZipSource.md#getpartitiontable)
- [listenerCount](sourceDestination.StreamZipSource.md#listenercount)
- [listeners](sourceDestination.StreamZipSource.md#listeners)
- [off](sourceDestination.StreamZipSource.md#off)
- [on](sourceDestination.StreamZipSource.md#on)
- [once](sourceDestination.StreamZipSource.md#once)
- [open](sourceDestination.StreamZipSource.md#open)
- [prependListener](sourceDestination.StreamZipSource.md#prependlistener)
- [prependOnceListener](sourceDestination.StreamZipSource.md#prependoncelistener)
- [rawListeners](sourceDestination.StreamZipSource.md#rawlisteners)
- [read](sourceDestination.StreamZipSource.md#read)
- [removeAllListeners](sourceDestination.StreamZipSource.md#removealllisteners)
- [removeListener](sourceDestination.StreamZipSource.md#removelistener)
- [setMaxListeners](sourceDestination.StreamZipSource.md#setmaxlisteners)
- [write](sourceDestination.StreamZipSource.md#write)
- [addAbortListener](sourceDestination.StreamZipSource.md#addabortlistener)
- [getEventListeners](sourceDestination.StreamZipSource.md#geteventlisteners)
- [getMaxListeners](sourceDestination.StreamZipSource.md#getmaxlisteners-1)
- [listenerCount](sourceDestination.StreamZipSource.md#listenercount-1)
- [on](sourceDestination.StreamZipSource.md#on-1)
- [once](sourceDestination.StreamZipSource.md#once-1)
- [register](sourceDestination.StreamZipSource.md#register)
- [setMaxListeners](sourceDestination.StreamZipSource.md#setmaxlisteners-1)
...
[lib/source-destination/zip.ts:73](https://github.com/balena-io-modules/etcher-sdk/blob/00df1fd/lib/source-destination/zip.ts#L73)

## Properties

### entry

• `Private` `Optional` **entry**: `ZipStreamEntry`

#### Defined in

[lib/source-destination/zip.ts:71](https://github.com/balena-io-modules/etcher-sdk/blob/00df1fd/lib/source-destination/zip.ts#L71)
...
[lib/source-destination/zip.ts:75](https://github.com/balena-io-modules/etcher-sdk/blob/00df1fd/lib/source-destination/zip.ts#L75)
...
[lib/source-destination/zip.ts:118](https://github.com/balena-io-modules/etcher-sdk/blob/00df1fd/lib/source-destination/zip.ts#L118)
...
▸ **addListener**(`eventName`, `listener`): [`StreamZipSource`](sourceDestination.StreamZipSource.md)
...
[lib/source-destination/zip.ts:80](https://github.com/balena-io-modules/etcher-sdk/blob/00df1fd/lib/source-destination/zip.ts#L80)
...
[lib/source-destination/zip.ts:102](https://github.com/balena-io-modules/etcher-sdk/blob/00df1fd/lib/source-destination/zip.ts#L102)
...
[lib/source-destination/zip.ts:84](https://github.com/balena-io-modules/etcher-sdk/blob/00df1fd/lib/source-destination/zip.ts#L84)
...
set by `emitter.setMaxListeners(n)` or defaults to [defaultMaxListeners](sourceDestination.StreamZipSource.md#defaultmaxlisteners).
...
▸ **off**(`eventName`, `listener`): [`StreamZipSource`](sourceDestination.StreamZipSource.md)
...
▸ **on**(`eventName`, `listener`): [`StreamZipSource`](sourceDestination.StreamZipSource.md)
...
▸ **once**(`eventName`, `listener`): [`StreamZipSource`](sourceDestination.StreamZipSource.md)
...
▸ **prependListener**(`eventName`, `listener`): [`StreamZipSource`](sourceDestination.StreamZipSource.md)
...
▸ **prependOnceListener**(`eventName`, `listener`): [`StreamZipSource`](sourceDestination.StreamZipSource.md)
...
▸ **removeAllListeners**(`event?`): [`StreamZipSource`](sourceDestination.StreamZipSource.md)
...
▸ **removeListener**(`eventName`, `listener`): [`StreamZipSource`](sourceDestination.StreamZipSource.md)
...
▸ **setMaxListeners**(`n`): [`StreamZipSource`](sourceDestination.StreamZipSource.md)
