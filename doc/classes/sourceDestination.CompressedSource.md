[etcher-sdk](../README.md) / [sourceDestination](../modules/sourceDestination.md) / CompressedSource

# Class: CompressedSource

[sourceDestination](../modules/sourceDestination.md).CompressedSource
...
- [constructor](sourceDestination.CompressedSource.md#constructor)

### Properties

- [source](sourceDestination.CompressedSource.md#source)
- [captureRejectionSymbol](sourceDestination.CompressedSource.md#capturerejectionsymbol)
- [captureRejections](sourceDestination.CompressedSource.md#capturerejections)
- [defaultMaxListeners](sourceDestination.CompressedSource.md#defaultmaxlisteners)
- [errorMonitor](sourceDestination.CompressedSource.md#errormonitor)
- [imageExtensions](sourceDestination.CompressedSource.md#imageextensions)
- [mimetype](sourceDestination.CompressedSource.md#mimetype)
- [requiresRandomReadableSource](sourceDestination.CompressedSource.md#requiresrandomreadablesource)

### Methods

- [[captureRejectionSymbol]](sourceDestination.CompressedSource.md#[capturerejectionsymbol])
- [\_close](sourceDestination.CompressedSource.md#_close)
- [\_getMetadata](sourceDestination.CompressedSource.md#_getmetadata)
- [\_open](sourceDestination.CompressedSource.md#_open)
- [addListener](sourceDestination.CompressedSource.md#addlistener)
- [canCreateReadStream](sourceDestination.CompressedSource.md#cancreatereadstream)
- [canCreateSparseReadStream](sourceDestination.CompressedSource.md#cancreatesparsereadstream)
- [canCreateSparseWriteStream](sourceDestination.CompressedSource.md#cancreatesparsewritestream)
- [canCreateWriteStream](sourceDestination.CompressedSource.md#cancreatewritestream)
- [canRead](sourceDestination.CompressedSource.md#canread)
- [canWrite](sourceDestination.CompressedSource.md#canwrite)
- [close](sourceDestination.CompressedSource.md#close)
- [createReadStream](sourceDestination.CompressedSource.md#createreadstream)
- [createSparseReadStream](sourceDestination.CompressedSource.md#createsparsereadstream)
- [createSparseWriteStream](sourceDestination.CompressedSource.md#createsparsewritestream)
- [createTransform](sourceDestination.CompressedSource.md#createtransform)
- [createVerifier](sourceDestination.CompressedSource.md#createverifier)
- [createWriteStream](sourceDestination.CompressedSource.md#createwritestream)
- [emit](sourceDestination.CompressedSource.md#emit)
- [eventNames](sourceDestination.CompressedSource.md#eventnames)
- [getAlignment](sourceDestination.CompressedSource.md#getalignment)
- [getBlocks](sourceDestination.CompressedSource.md#getblocks)
- [getInnerSource](sourceDestination.CompressedSource.md#getinnersource)
- [getMaxListeners](sourceDestination.CompressedSource.md#getmaxlisteners)
- [getMetadata](sourceDestination.CompressedSource.md#getmetadata)
- [getPartitionTable](sourceDestination.CompressedSource.md#getpartitiontable)
- [getSize](sourceDestination.CompressedSource.md#getsize)
- [getSizeFromPartitionTable](sourceDestination.CompressedSource.md#getsizefrompartitiontable)
- [listenerCount](sourceDestination.CompressedSource.md#listenercount)
- [listeners](sourceDestination.CompressedSource.md#listeners)
- [off](sourceDestination.CompressedSource.md#off)
- [on](sourceDestination.CompressedSource.md#on)
- [once](sourceDestination.CompressedSource.md#once)
- [open](sourceDestination.CompressedSource.md#open)
- [prependListener](sourceDestination.CompressedSource.md#prependlistener)
- [prependOnceListener](sourceDestination.CompressedSource.md#prependoncelistener)
- [rawListeners](sourceDestination.CompressedSource.md#rawlisteners)
- [read](sourceDestination.CompressedSource.md#read)
- [removeAllListeners](sourceDestination.CompressedSource.md#removealllisteners)
- [removeListener](sourceDestination.CompressedSource.md#removelistener)
- [setMaxListeners](sourceDestination.CompressedSource.md#setmaxlisteners)
- [write](sourceDestination.CompressedSource.md#write)
- [addAbortListener](sourceDestination.CompressedSource.md#addabortlistener)
- [getEventListeners](sourceDestination.CompressedSource.md#geteventlisteners)
- [getMaxListeners](sourceDestination.CompressedSource.md#getmaxlisteners-1)
- [listenerCount](sourceDestination.CompressedSource.md#listenercount-1)
- [on](sourceDestination.CompressedSource.md#on-1)
- [once](sourceDestination.CompressedSource.md#once-1)
- [register](sourceDestination.CompressedSource.md#register)
- [setMaxListeners](sourceDestination.CompressedSource.md#setmaxlisteners-1)
...
▸ **addListener**(`eventName`, `listener`): [`CompressedSource`](sourceDestination.CompressedSource.md)
...
[lib/source-destination/compressed-source.ts:45](https://github.com/balena-io-modules/etcher-sdk/blob/00df1fd/lib/source-destination/compressed-source.ts#L45)
...
set by `emitter.setMaxListeners(n)` or defaults to [defaultMaxListeners](sourceDestination.CompressedSource.md#defaultmaxlisteners).
...
[lib/source-destination/compressed-source.ts:47](https://github.com/balena-io-modules/etcher-sdk/blob/00df1fd/lib/source-destination/compressed-source.ts#L47)
...
▸ **off**(`eventName`, `listener`): [`CompressedSource`](sourceDestination.CompressedSource.md)
...
▸ **on**(`eventName`, `listener`): [`CompressedSource`](sourceDestination.CompressedSource.md)
...
▸ **once**(`eventName`, `listener`): [`CompressedSource`](sourceDestination.CompressedSource.md)
...
▸ **prependListener**(`eventName`, `listener`): [`CompressedSource`](sourceDestination.CompressedSource.md)
...
▸ **prependOnceListener**(`eventName`, `listener`): [`CompressedSource`](sourceDestination.CompressedSource.md)
...
▸ **removeAllListeners**(`event?`): [`CompressedSource`](sourceDestination.CompressedSource.md)
...
▸ **removeListener**(`eventName`, `listener`): [`CompressedSource`](sourceDestination.CompressedSource.md)
...
▸ **setMaxListeners**(`n`): [`CompressedSource`](sourceDestination.CompressedSource.md)
