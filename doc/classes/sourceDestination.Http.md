[etcher-sdk](../README.md) / [sourceDestination](../modules/sourceDestination.md) / Http

# Class: Http

[sourceDestination](../modules/sourceDestination.md).Http
...
- [constructor](sourceDestination.Http.md#constructor)

### Properties

- [acceptsRange](sourceDestination.Http.md#acceptsrange)
- [avoidRandomAccess](sourceDestination.Http.md#avoidrandomaccess)
- [axiosInstance](sourceDestination.Http.md#axiosinstance)
- [error](sourceDestination.Http.md#error)
- [fileName](sourceDestination.Http.md#filename)
- [ready](sourceDestination.Http.md#ready)
- [redirectUrl](sourceDestination.Http.md#redirecturl)
- [size](sourceDestination.Http.md#size)
- [url](sourceDestination.Http.md#url)
- [captureRejectionSymbol](sourceDestination.Http.md#capturerejectionsymbol)
- [captureRejections](sourceDestination.Http.md#capturerejections)
- [defaultMaxListeners](sourceDestination.Http.md#defaultmaxlisteners)
- [errorMonitor](sourceDestination.Http.md#errormonitor)
- [imageExtensions](sourceDestination.Http.md#imageextensions)
- [mimetype](sourceDestination.Http.md#mimetype)

### Methods

- [[captureRejectionSymbol]](sourceDestination.Http.md#[capturerejectionsymbol])
- [\_close](sourceDestination.Http.md#_close)
- [\_getMetadata](sourceDestination.Http.md#_getmetadata)
- [\_open](sourceDestination.Http.md#_open)
- [addListener](sourceDestination.Http.md#addlistener)
- [canCreateReadStream](sourceDestination.Http.md#cancreatereadstream)
- [canCreateSparseReadStream](sourceDestination.Http.md#cancreatesparsereadstream)
- [canCreateSparseWriteStream](sourceDestination.Http.md#cancreatesparsewritestream)
- [canCreateWriteStream](sourceDestination.Http.md#cancreatewritestream)
- [canRead](sourceDestination.Http.md#canread)
- [canWrite](sourceDestination.Http.md#canwrite)
- [close](sourceDestination.Http.md#close)
- [createReadStream](sourceDestination.Http.md#createreadstream)
- [createSparseReadStream](sourceDestination.Http.md#createsparsereadstream)
- [createSparseWriteStream](sourceDestination.Http.md#createsparsewritestream)
- [createVerifier](sourceDestination.Http.md#createverifier)
- [createWriteStream](sourceDestination.Http.md#createwritestream)
- [emit](sourceDestination.Http.md#emit)
- [eventNames](sourceDestination.Http.md#eventnames)
- [getAlignment](sourceDestination.Http.md#getalignment)
- [getBlocks](sourceDestination.Http.md#getblocks)
- [getInfo](sourceDestination.Http.md#getinfo)
- [getInnerSource](sourceDestination.Http.md#getinnersource)
- [getMaxListeners](sourceDestination.Http.md#getmaxlisteners)
- [getMetadata](sourceDestination.Http.md#getmetadata)
- [getPartitionTable](sourceDestination.Http.md#getpartitiontable)
- [getRange](sourceDestination.Http.md#getrange)
- [listenerCount](sourceDestination.Http.md#listenercount)
- [listeners](sourceDestination.Http.md#listeners)
- [off](sourceDestination.Http.md#off)
- [on](sourceDestination.Http.md#on)
- [once](sourceDestination.Http.md#once)
- [open](sourceDestination.Http.md#open)
- [prependListener](sourceDestination.Http.md#prependlistener)
- [prependOnceListener](sourceDestination.Http.md#prependoncelistener)
- [rawListeners](sourceDestination.Http.md#rawlisteners)
- [read](sourceDestination.Http.md#read)
- [removeAllListeners](sourceDestination.Http.md#removealllisteners)
- [removeListener](sourceDestination.Http.md#removelistener)
- [setMaxListeners](sourceDestination.Http.md#setmaxlisteners)
- [write](sourceDestination.Http.md#write)
- [addAbortListener](sourceDestination.Http.md#addabortlistener)
- [getEventListeners](sourceDestination.Http.md#geteventlisteners)
- [getMaxListeners](sourceDestination.Http.md#getmaxlisteners-1)
- [listenerCount](sourceDestination.Http.md#listenercount-1)
- [on](sourceDestination.Http.md#on-1)
- [once](sourceDestination.Http.md#once-1)
- [register](sourceDestination.Http.md#register)
- [setMaxListeners](sourceDestination.Http.md#setmaxlisteners-1)
...
[lib/source-destination/http.ts:45](https://github.com/balena-io-modules/etcher-sdk/blob/00df1fd/lib/source-destination/http.ts#L45)
...
[lib/source-destination/http.ts:40](https://github.com/balena-io-modules/etcher-sdk/blob/00df1fd/lib/source-destination/http.ts#L40)
...
[lib/source-destination/http.ts:38](https://github.com/balena-io-modules/etcher-sdk/blob/00df1fd/lib/source-destination/http.ts#L38)
...
[lib/source-destination/http.ts:43](https://github.com/balena-io-modules/etcher-sdk/blob/00df1fd/lib/source-destination/http.ts#L43)
...
[lib/source-destination/http.ts:42](https://github.com/balena-io-modules/etcher-sdk/blob/00df1fd/lib/source-destination/http.ts#L42)
...
[lib/source-destination/http.ts:35](https://github.com/balena-io-modules/etcher-sdk/blob/00df1fd/lib/source-destination/http.ts#L35)
...
[lib/source-destination/http.ts:41](https://github.com/balena-io-modules/etcher-sdk/blob/00df1fd/lib/source-destination/http.ts#L41)
...
[lib/source-destination/http.ts:37](https://github.com/balena-io-modules/etcher-sdk/blob/00df1fd/lib/source-destination/http.ts#L37)

___

### size

• `Private` **size**: `undefined` \| `number`

#### Defined in

[lib/source-destination/http.ts:39](https://github.com/balena-io-modules/etcher-sdk/blob/00df1fd/lib/source-destination/http.ts#L39)
...
[lib/source-destination/http.ts:36](https://github.com/balena-io-modules/etcher-sdk/blob/00df1fd/lib/source-destination/http.ts#L36)
...
[lib/source-destination/http.ts:108](https://github.com/balena-io-modules/etcher-sdk/blob/00df1fd/lib/source-destination/http.ts#L108)
...
▸ **addListener**(`eventName`, `listener`): [`Http`](sourceDestination.Http.md)
...
[lib/source-destination/http.ts:104](https://github.com/balena-io-modules/etcher-sdk/blob/00df1fd/lib/source-destination/http.ts#L104)
...
[lib/source-destination/http.ts:96](https://github.com/balena-io-modules/etcher-sdk/blob/00df1fd/lib/source-destination/http.ts#L96)
...
[lib/source-destination/http.ts:153](https://github.com/balena-io-modules/etcher-sdk/blob/00df1fd/lib/source-destination/http.ts#L153)
...
[lib/source-destination/http.ts:67](https://github.com/balena-io-modules/etcher-sdk/blob/00df1fd/lib/source-destination/http.ts#L67)
...
set by `emitter.setMaxListeners(n)` or defaults to [defaultMaxListeners](sourceDestination.Http.md#defaultmaxlisteners).
...
[lib/source-destination/http.ts:123](https://github.com/balena-io-modules/etcher-sdk/blob/00df1fd/lib/source-destination/http.ts#L123)
...
▸ **off**(`eventName`, `listener`): [`Http`](sourceDestination.Http.md)
...
▸ **on**(`eventName`, `listener`): [`Http`](sourceDestination.Http.md)
...
▸ **once**(`eventName`, `listener`): [`Http`](sourceDestination.Http.md)
...
▸ **prependListener**(`eventName`, `listener`): [`Http`](sourceDestination.Http.md)
...
▸ **prependOnceListener**(`eventName`, `listener`): [`Http`](sourceDestination.Http.md)
...
[lib/source-destination/http.ts:132](https://github.com/balena-io-modules/etcher-sdk/blob/00df1fd/lib/source-destination/http.ts#L132)

___

### removeAllListeners

▸ **removeAllListeners**(`event?`): [`Http`](sourceDestination.Http.md)
...
▸ **removeListener**(`eventName`, `listener`): [`Http`](sourceDestination.Http.md)
...
▸ **setMaxListeners**(`n`): [`Http`](sourceDestination.Http.md)
