...
import * as sudoPrompt from '@balena/sudo-prompt'; // TODO: check @vscode/sudo-prompt
...
export async function isElevated(): Promise<boolean> {
	...
	const euid = process.geteuid && process.geteuid()
	return euid === UNIX_SUPERUSER_USER_ID;
}
