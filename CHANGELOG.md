...
<details>
<summary> Update dependency node-raspberrypi-usbboot to v1.1.12 [balena-renovate[bot]] </summary>

> ### node-raspberrypi-usbboot-1.1.12 - 2026-07-16
> 
> * Update dependency @types/node to v20.19.43 [balena-renovate[bot]]
> 
> ### node-raspberrypi-usbboot-1.1.11 - 2026-07-16
> 
> * Pin dependencies [balena-renovate[bot]]
> 
> ### node-raspberrypi-usbboot-1.1.10 - 2026-06-08
> 
> * Lock file maintenance [balena-renovate[bot]]
> 
> ### node-raspberrypi-usbboot-1.1.9 - 2026-06-01
> 
> * Lock file maintenance [balena-renovate[bot]]
> 
> ### node-raspberrypi-usbboot-1.1.8 - 2026-05-25
> 
> * Lock file maintenance [balena-renovate[bot]]
> 
> ### node-raspberrypi-usbboot-1.1.7 - 2026-05-18
> 
> * Lock file maintenance [balena-renovate[bot]]
> 
> ### node-raspberrypi-usbboot-1.1.6 - 2026-05-16
> 
> * Update dependency rimraf to ^6.1.2 [balena-renovate[bot]]
> 
> ### node-raspberrypi-usbboot-1.1.5 - 2026-02-19
> 
> * Add id-token: write permission for NPM OIDC publishing [Kyle Harding]
> 
> ### node-raspberrypi-usbboot-1.1.4 - 2026-01-22
> 
> * Lock file maintenance [balena-renovate[bot]]
> 
> ### node-raspberrypi-usbboot-1.1.3 - 2025-04-07
> 
> * Lock file maintenance [balena-renovate[bot]]
> 
> ### node-raspberrypi-usbboot-1.1.2 - 2025-04-02
> 
> * Update dependency rimraf to v6 [balena-renovate[bot]]
> 
> ### node-raspberrypi-usbboot-1.1.1 - 2025-03-19
> 
...
* Regenerate docs [Thodoris Greasidis]

## 10.2.12 - 2026-06-18

* url-compressed-source: Separate the size estimation parts from the part streaming [Thodoris Greasidis]

## 10.2.11 - 2026-06-18

* url-compressed-source: Avoid creating gz streams while estimating size [Thodoris Greasidis]

<details>
<summary> Update gzip-stream to 2.1.0 [Thodoris Greasidis] </summary>

> ### gzip-stream-2.1.0 - 2026-06-18
> 
...
* Remove the `Dictionary` type sugar in favor of using `Record` directly [Thodoris Greasidis]

## 10.2.9 - 2026-06-17

* URLCompressedSource.createReadStream deprecate the options parameter [Thodoris Greasidis]
* Deprecate the BalenaS3Source class [Thodoris Greasidis]
* Deprecate the BalenaS3SourceBase class [Thodoris Greasidis]
* Deprecate the BalenaS3CompressedSource class [Thodoris Greasidis]
* BalenaS3CompressedSource.createReadStream deprecate the options parameter [Thodoris Greasidis]

## 10.2.8 - 2026-06-16

* url-compressed-source: Cleanup all streams [Thodoris Greasidis]

## 10.2.7 - 2026-06-15

* url-compressed-source: Improve axios stream response type as Readable [Thodoris Greasidis]

## 10.2.6 - 2026-06-15

* url-compressed-source: Use pipeline during the ZipStream construction [Thodoris Greasidis]

## 10.2.5 - 2026-06-11

* url-compressed-source: Reduce the places that getParts is called to make it easier to reason [Thodoris Greasidis]

## 10.2.4 - 2026-06-11

* url-compressed-source: Use an empty Buffer instead of a dummy Stream while estimating the download size [Thodoris Greasidis]

## 10.2.3 - 2026-06-10

* url-compressed-source: Use pipeline on streams during configuration [Thodoris Greasidis]

## 10.2.2 - 2026-06-08

* url-compressed-source: Fix zipped img permissions to be 644 [Thodoris Greasidis]

## 10.2.1 - 2026-06-05

* url-compressed-source: Fix the stream cleanup on error [Thodoris Greasidis]

## 10.2.0 - 2026-06-04

* url-compressed-source: Switch to compress-commons to support zip64 [Thodoris Greasidis]

<details>
<summary> Update gzip-stream to 2.0.3 to add support for files > 4GB [Thodoris Greasidis] </summary>

> ### gzip-stream-2.0.3 - 2026-06-03
> 
> * Update @balena/node-crc-utils to 3.1.0 & use the built-in 4GB part normalization [Thodoris Greasidis]
> 
> ### gzip-stream-2.0.2 - 2026-06-01
> 
> * Fix compressing files larger than 4GB [Thodoris Greasidis]
> 
> ### gzip-stream-2.0.1 - 2026-02-18
> 
> * Add id-token: write permission for NPM OIDC publishing [Kyle Harding]
> 
...
* Add tests for the BalenaS3CompressedSource & UrlCompressedSource modules [Thodoris Greasidis]

## 10.1.6 - 2026-05-27

* Properly lint typings & tests [Thodoris Greasidis]
...
* Update dependency minimatch to v9.0.6 [SECURITY] [balena-renovate[bot]]
...
* Update dependency axios to v1.13.5 [SECURITY] [balena-renovate[bot]]

## 10.1.0 - 2025-11-27

* Add URLCompressedSource class [Otavio Jacobi]

## 10.0.2 - 2025-11-24

* Update dependency axios to v1.12.0 [SECURITY] [balena-renovate[bot]]

## 10.0.1 - 2025-11-24

* Update mocha to 11.7.5 [Thodoris Greasidis]
